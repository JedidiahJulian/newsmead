...
object AccuracyReport {
    fun payload(session: AccuracySession, id: String, device: String, pipeline: Map<String, Any?>,
        ...
        return linkedMapOf(
            "schema" to if (session.phase == AccuracySession.Phase.COMPLETE) "mgazenet_accuracy_v1" else "mgazenet_accuracy_partial_v1",
            ...
            "clock" to "shared_monotonic_ms", "max_output_age_ms" to session.maxAgeMs,
